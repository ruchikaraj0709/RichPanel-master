        ...
        < div className='body4'>
            ...
            <div className='grid h-screen place-items-center '>
                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                    ...
                    <div class="px-6 py-4">
                        {/* eslint-disable-line */}
                        {/* eslint-disable-line */}<div class="font-bold text-xl mb-2">{cancelTime && <>Sorry {user.displayName} your plan is cancelled</> || <>Welcome to your plan {user.displayName}</>}</div>
                        <p class="text-gray-700 text-base">
                           {/* eslint-disable-line */} {cancelTime && <p>Your subscription was canceled at {cancelTime}</p> || <> You have opted for the plan, {userData.plan} and thus will get benifits accordingly. </>}
                        </p>
                    </div>
                    <div class="px-6 pt-4 pb-2">
                        ...
                        {/* eslint-disable-line */}{!cancelTime && <button onClick={cancelSub} class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Cancel You Plan?</button> ||
                            <button onClick={() => {
                                navigate('/billing')
